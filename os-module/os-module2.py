...
# ['module', '.git', 'arr', 'others', 'regexp', 'soCkets', 'os-module', 'py-game', 'graph', 'thread--', 'arg-parse', 'file-handle', 'template']
print(os.listdir('/home/raghav/Desktop/gitHub/what-I-learned/py-advance/'))
