...
open('x.txt', 'w')
# os.walk() is a generator which yeilds 3 tuple
for dirPath, dirName, fileName in os.walk('/home/raghav/Desktop/gitHub'):
...
fileName = os.path.isfile(
    '/home/raghav/Desktop/gitHub/what-I-learned/py-advance/os-module/os-module1.py')
print(fileName)  # True
fileName = os.path.isdir(
    '/home/raghav/Desktop/gitHub/what-I-learned/py-advance/os-module/os-module1.py')
